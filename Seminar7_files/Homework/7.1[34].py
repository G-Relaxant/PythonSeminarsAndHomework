...
(*) Усложнение.
Функция имеет параметр, который определяет, надо ли возвращать полную информацию о кол-ве гласных букв в фразах. Эта информация возвращается
в виде списка словарей. Каждый элемент списка(словарь) соответствует фразе.
Примеры/Тесты:
...
# song1 = "пара-ра-рам рам-пам-папам па-ра-па-дам"
# song2 = "пара-ра-рам рам-пум-пупам па-ре-по-дам"
# song3 = "пара-ра-рам рам-пуум-пупам па-ре-по-дам"
# song4 = "Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"
# song5 = "Пам-парам-пурум Пум-пурум-карам"

# def setSongSplit(a: str) -> set:
#     set1 = a.split()
#     return set1

# def 

# print(setSongSplit(song1))
# не успеваю
